...
public class SliderViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{R.layout.slider_1,R.layout.slider2, R.layout.slider3,};
    ...
    private void setDotStatus(int page){
      // layoutDot.removeAllViews();
        ...
        if (((LinearLayout) layoutDot).getChildCount()>0){
            ((LinearLayout) layoutDot).removeAllViews();
        }
    ...
    private void startMainActivity(){
        ...
        //startActivity(new Intent(SliderViewActivity.this, MainActivity.class));
        finish();
    }
